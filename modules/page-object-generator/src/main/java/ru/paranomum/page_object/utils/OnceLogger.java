...
public class OnceLogger extends LoggerWrapper {
     ...
     */
    static final String CACHE_SIZE_PROPERTY = "ru.paranomum.page_object.utils.oncelogger.cachesize";
     ...
     */
    static final String ENABLE_ONCE_LOGGER_PROPERTY = "ru.paranomum.page_object.utils.oncelogger.enabled";

    /**
     * Allow advanced users to modify cache expiration of the OnceLogger (more for performance tuning in hosted environments)
     */
    static final String EXPIRY_PROPERTY = "ru.paranomum.page_object.utils.oncelogger.expiry";
